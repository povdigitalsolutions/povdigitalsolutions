    ...
    <Card className="card-premium group flex flex-col overflow-hidden h-full">
          ...
          {template.thumbnail ? (
            <Image
              ...
              alt={`${template.name} website demo`}
              fill
              sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
              className="object-cover transition-transform duration-700 group-hover:scale-105"
            />
          ) : (
            <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-brand-light via-brand/5 to-brand-dark/10">
              <Monitor className="h-12 w-12 text-brand/30" />
            </div>
          )}
